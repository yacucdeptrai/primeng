...
/**
 * SliderAlt is a single-handle drag-input control mirroring the v17 fork behavior.
 * @group Components
 */
@Component({
    ...
    `,
    providers: [SLIDER_VALUE_ACCESSOR, SliderAltStyle],
...
export class SliderAlt implements OnDestroy, ControlValueAccessor {
    ...
    _componentStyle = inject(SliderAltStyle);

...
import { TemplateRef, EventEmitter, OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ElementRef, Signal, QueryList, NgZone } from '@angular/core';
 ...
 * @group Components
 */
declare class MultiSelect extends BaseComponent implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ControlValueAccessor {
    private zone;

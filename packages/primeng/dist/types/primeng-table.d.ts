...
declare class Table<RowData = any> extends BaseComponent implements OnInit, AfterViewInit, AfterContentInit, BlockableUI, OnChanges {
    ...
    static ngAcceptInputType_pageLinks: 
    /**
    ...
    static ngAcceptInputType_defaultSortOrder: 
    /**
     * Callback to invoke on overlay is shown.
     * @param {AnimationEvent} originalEvent - animation event.
     * @group Emits
    ...
    static ngAcceptInputType_filterDelay: 
    /**
     * Callback to invoke on overlay is shown.
     * @param {AnimationEvent} originalEvent - animation event.
     * @group Emits
    ...
    static ngAcceptInputType_virtualScrollItemSize: 
    /**
     * Callback to invoke on overlay is shown.
     * @param {AnimationEvent} originalEvent - animation event.
     * @group Emits
     */
    unknown;
    static ngAcceptInputType_virtualScrollDelay: 
    /**
     * Callback to invoke on overlay is shown.
     * @param {AnimationEvent} originalEvent - animation event.
     * @group Emits
    ...
    static ngAcceptInputType_groupRowsByOrder: 
    /**
     * Callback to invoke on overlay is shown.
     * @param {AnimationEvent} originalEvent - animation event.
     * @group Emits
...
declare class TableRadioButton {
    ...
    static ngAcceptInputType_index: 
    /**
     * Callback to invoke on overlay is shown.
     * @param {AnimationEvent} originalEvent - animation event.
     * @group Emits
...
declare class ColumnFilter extends BaseComponent implements AfterContentInit {
    ...
    static ngAcceptInputType_maxConstraints: 
    /**
     * Callback to invoke on overlay is shown.
     * @param {AnimationEvent} originalEvent - animation event.
     * @group Emits

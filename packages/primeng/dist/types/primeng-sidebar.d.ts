...
import { AfterViewInit, AfterContentInit, OnDestroy, ElementRef, TemplateRef, EventEmitter, QueryList, SimpleChanges } from '@angular/core';
 ...
 * @group Components
 */
declare class Sidebar extends BaseComponent implements AfterViewInit, AfterContentInit, OnDestroy {
    /**

...
import { TemplateRef, AfterViewChecked, AfterContentInit, OnDestroy, ElementRef, EventEmitter, NgZone, QueryList } from '@angular/core';
 ...
 * @group Components
 */
declare class AutoComplete extends BaseComponent implements AfterViewChecked, AfterContentInit, OnDestroy, ControlValueAccessor {
    ...
    private primeng;
    value: string | any;
    _suggestions: i0.WritableSignal<any>;

...
import { TemplateRef, EventEmitter, OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, NgZone, ElementRef, Signal, QueryList } from '@angular/core';
import { AnimationEvent } from '@angular/animations';
import { ControlValueAccessor } from '@angular/forms';
import * as i3 from 'primeng/api';
import { ScrollerOptions, SelectItem, FilterService, OverlayOptions, PrimeTemplate } from 'primeng/api';
...
declare enum DropdownClasses {
}
declare class DropdownStyle extends BaseStyle {
    name: string;
    theme: ({ dt }: {
        dt: any;
    }) => string;
...
interface DropdownStyle extends SelectStyle {
}

declare const DROPDOWN_VALUE_ACCESSOR: any;
declare class DropdownItem extends BaseComponent {
    id: string | undefined;
 ...
 * @group Components
 */
declare class Dropdown extends BaseComponent implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ControlValueAccessor {
    zone: NgZone;

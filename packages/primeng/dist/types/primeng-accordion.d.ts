...
import { InputSignalWithTransform, TemplateRef, AfterContentInit, OnDestroy, EventEmitter, QueryList } from '@angular/core';
 ...
 * @group Components
 */
declare class AccordionTab extends BaseComponent implements AfterContentInit, OnDestroy {
 ...
 * @group Components
 */
declare class Accordion extends BaseComponent implements BlockableUI, AfterContentInit, OnDestroy {
    get hostClass(): string;
    get hostStyle(): {
        [klass: string]: any;
    };

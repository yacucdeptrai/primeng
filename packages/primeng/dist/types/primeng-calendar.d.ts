...
import { TemplateRef, OnInit, AfterContentInit, OnDestroy, ElementRef, EventEmitter, NgZone, QueryList } from '@angular/core';
...
declare class CalendarStyle extends BaseStyle {
    name: string;
    theme: ({ dt }: {
        dt: any;
    }) => string;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<CalendarStyle, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<CalendarStyle>;
}
 ...
 * @group Components
 */
declare class Calendar extends BaseComponent implements OnInit, AfterContentInit, OnDestroy, ControlValueAccessor {
    private zone;

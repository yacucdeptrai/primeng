...
import { OnDestroy, DoCheck, NgZone, PipeTransform, OnInit, AfterContentInit, ElementRef, TemplateRef, EventEmitter, QueryList } from '@angular/core';
 ...
 * @group Components
 */
declare class PasswordDirective extends BaseComponent implements OnDestroy, DoCheck {
    zone: NgZone;
    /**
 ...
 * @group Components
 */
declare class Password extends BaseComponent implements OnInit, AfterContentInit {
    /**

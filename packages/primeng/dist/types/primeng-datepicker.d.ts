...
import { TemplateRef, OnInit, AfterContentInit, AfterViewInit, OnDestroy, ElementRef, EventEmitter, NgZone, QueryList } from '@angular/core';
 ...
 * @group Components
 */
declare class DatePicker extends BaseComponent implements OnInit, AfterContentInit, AfterViewInit, OnDestroy, ControlValueAccessor {
    private zone;

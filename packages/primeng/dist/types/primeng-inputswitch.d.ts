...
declare class InputSwitchStyle extends BaseStyle {
    name: string;
    theme: ({ dt }: {
        dt: any;
    }) => string;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<InputSwitchStyle, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<InputSwitchStyle>;
}
 ...
 * @group Components
 */
declare class InputSwitch extends BaseComponent {
    /**

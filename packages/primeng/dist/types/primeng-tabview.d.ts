...
import { TemplateRef, AfterContentInit, OnDestroy, QueryList, AfterViewChecked, EventEmitter, ElementRef } from '@angular/core';
 ...
 * @group Components
 */
declare class TabPanel extends BaseComponent implements AfterContentInit, OnDestroy {
    /**
 ...
 * @group Components
 */
declare class TabView extends BaseComponent implements AfterContentInit, AfterViewChecked, OnDestroy, BlockableUI {

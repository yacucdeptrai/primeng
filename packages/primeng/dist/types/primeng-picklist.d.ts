...
import { TemplateRef, AfterViewChecked, AfterContentInit, EventEmitter, ElementRef, QueryList } from '@angular/core';
 ...
 * @group Components
 */
declare class PickList extends BaseComponent implements AfterViewChecked, AfterContentInit {
    /**

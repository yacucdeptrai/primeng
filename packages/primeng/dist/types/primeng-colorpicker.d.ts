...
import { OnDestroy, AfterViewInit, ElementRef, TemplateRef, EventEmitter } from '@angular/core';
 ...
 * @group Components
 */
declare class ColorPicker extends BaseComponent implements ControlValueAccessor, OnDestroy, AfterViewInit {

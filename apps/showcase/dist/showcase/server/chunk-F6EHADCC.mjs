...
import{a as M,b as Q}from"./chunk-FYZRR3RL.mjs";import{a as H,b as J}from"./chunk-ZRV7YDR2.mjs";import{a as V,b as q}from"./chunk-TUWVE3ES.mjs";import{a as U,b as K}from"./chunk-IIW25JG6.mjs";import{a as v,d as G,e as I}from"./chunk-HZSAMTDM.mjs";import{a as g,b as R}from"./chunk-EK6YV52O.mjs";import{e as k,f as T,g as N,i as A,j as b,k as B,l as z,m as j,s as P,t as O}from"./chunk-TFKM2WIB.mjs";import"./chunk-OEKEPL5T.mjs";import"./chunk-25YO5GOD.mjs";import"./chunk-3SL6YYR2.mjs";import"./chunk-DE54ZEHA.mjs";import"./chunk-YQJJ7I3T.mjs";import{f as _,j as W}from"./chunk-X4SEKHHA.mjs";import"./chunk-5H7TUZVV.mjs";import{v as L}from"./chunk-RUZVPFSZ.mjs";import{Bb as p,Cb as t,Db as o,Eb as m,O as F,Sa as r,ec as e,gb as d,hb as w,jc as c,kc as u,lc as f,pc as E}from"./chunk-ZJKG6QAF.mjs";import"./chunk-AFOT676I.mjs";var X=(()=>{class i{code={basic:`<label for="date">Date</label>
...
export class InputMaskOptionalDemo {
    value: string | undefined;
}`};static \u0275fac=function(n){return new(n||i)};static \u0275cmp=d({type:i,selectors:[["optional-doc"]],standalone:!1,decls:12,vars:2,consts:[[1,"card","flex","justify-center"],["mask","(999) 999-9999? x99999","placeholder","(999) 999-9999? x99999",3,"ngModelChange","ngModel"],["selector","input-mask-optional-demo",3,"code"]],template:function(n,a){n&1&&(t(0,"app-docsectiontext")(1,"p"),e(2,"When the input does not complete the mask definition, it is cleared by default. Use "),t(3,"i"),e(4,"autoClear"),o(),e(5," property to control this behavior. In addition, "),t(6,"i"),e(7,"?"),o(),e(8," is used to mark anything after the question mark optional."),o()(),t(9,"div",0)(10,"p-inputmask",1),f("ngModelChange",function(l){return u(a.value,l)||(a.value=l),l}),o()(),m(11,"app-code",2)),n&2&&(r(10),c("ngModel",a.value),r(),p("code",a.code))},dependencies:[k,b,M,g,v],encapsulation:2})}return i})();var le=(()=>{class i{formGroup;ngOnInit(){this.formGroup=new N({value:new A(null)})}code={basic:'<p-inputmask mask="99-999999" formControlName="value" placeholder="99-999999" />',html:`<div class="card flex justify-center">

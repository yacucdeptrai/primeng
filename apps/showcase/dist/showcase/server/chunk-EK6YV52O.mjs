...
import{a as de,b as le}from"./chunk-25YO5GOD.mjs";import{ba as se}from"./chunk-DE54ZEHA.mjs";import{A as ce,k as te,n as re,v as oe}from"./chunk-RUZVPFSZ.mjs";import{$a as P,Bb as l,Cb as s,Db as m,Eb as E,Ib as Q,Jb as ee,Lb as S,O as V,Qb as w,Sa as o,Sb as d,Wb as ae,X as b,Xb as ne,Y as h,Yb as ie,Z as U,Zc as B,aa as Y,ec as v,gb as X,gc as k,hb as Z,mb as I,qc as A,sa as $}from"./chunk-ZJKG6QAF.mjs";import{a as y,b as T,i as H}from"./chunk-AFOT676I.mjs";var xe="https://stackblitz.com",me=["angular-cli","create-react-app","html","javascript","node","polymer","typescript","vue"],De=["project","search","ports","settings"],Pe=["light","dark"],qe=["editor","preview"],ue={clickToLoad:e=>C("ctl",e),devToolsHeight:e=>pe("devtoolsheight",e),forceEmbedLayout:e=>C("embed",e),hideDevTools:e=>C("hidedevtools",e),hideExplorer:e=>C("hideExplorer",e),hideNavigation:e=>C("hideNavigation",e),openFile:e=>ge("file",e),showSidebar:e=>Fe("showSidebar",e),sidebarView:e=>q("sidebarView",e,De),startScript:e=>ge("startScript",e),terminalHeight:e=>pe("terminalHeight",e),theme:e=>q("theme",e,Pe),view:e=>q("view",e,qe),zenMode:e=>C("zenMode",e)};function ye(e={}){let n=Object.entries(e).map(([a,i])=>i!=null&&ue.hasOwnProperty(a)?ue[a](i):"").filter(Boolean);return n.length?`?${n.join("&")}`:""}function C(e,n){return n===!0?`${e}=1`:""}function Fe(e,n){return typeof n=="boolean"?`${e}=${n?"1":"0"}`:""}function pe(e,n){if(typeof n=="number"&&!Number.isNaN(n)){let a=Math.min(100,Math.max(0,n));return`${e}=${encodeURIComponent(Math.round(a))}`}return""}function q(e,n="",a=[]){return a.includes(n)?`${e}=${encodeURIComponent(n)}`:""}function ge(e,n){return(Array.isArray(n)?n:[n]).filter(i=>typeof i=="string"&&i.trim()!=="").map(i=>`${e}=${encodeURIComponent(i)}`).join("&")}function ve(){return Math.random().toString(36).slice(2,6)+Math.random().toString(36).slice(2,6)}function R(e,n){return`${fe(n)}${e}${ye(n)}`}function _(e,n){let a={forceEmbedLayout:!0};return n&&typeof n=="object"&&Object.assign(a,n),`${fe(a)}${e}${ye(a)}`}function fe(e={}){return(typeof e.origin=="string"?e.origin:xe).replace(/\/$/,"")}function O(e,n,a){if(!n||!e||!e.parentNode)throw new Error("Invalid Element");e.id&&(n.id=e.id),e.className&&(n.className=e.className),Le(n,a),e.replaceWith(n)}function z(e){if(typeof e=="string"){let n=document.getElementById(e);if(!n)throw new Error(`Could not find element with id '${e}'`);return n}else if(e instanceof HTMLElement)return e;throw new Error(`Invalid element: ${e}`)}function N(e){return e&&e.newWindow===!1?"_self":"_blank"}function Le(e,n={}){let a=Object.hasOwnProperty.call(n,"height")?`${n.height}`:"300",i=Object.hasOwnProperty.call(n,"width")?`${n.width}`:void 0;e.setAttribute("height",a),i?e.setAttribute("width",i):e.setAttribute("style","width:100%;")}var F=class{constructor(n){this.pending={},this.port=n,this.port.onmessage=this.messageListener.bind(this)}request({type:n,payload:a}){return new Promise((i,t)=>{let r=ve();this.pending[r]={resolve:i,reject:t},this.port.postMessage({type:n,payload:T(y({},a),{__reqid:r})})})}messageListener(n){if(typeof n.data.payload?.__reqid!="string")return;let{type:a,payload:i}=n.data,{__reqid:t,__success:r,__error:u}=i;this.pending[t]&&(r?this.pending[t].resolve(this.cleanResult(i)):this.pending[t].reject(u?`${a}: ${u}`:a),delete this.pending[t])}cleanResult(n){let a=y({},n);return delete a.__reqid,delete a.__success,delete a.__error,Object.keys(a).length?a:null}},L=class{constructor(n,a){this.editor={openFile:i=>this._rdc.request({type:"SDK_OPEN_FILE",payload:{path:i}}),setCurrentFile:i=>this._rdc.request({type:"SDK_SET_CURRENT_FILE",payload:{path:i}}),setTheme:i=>this._rdc.request({type:"SDK_SET_UI_THEME",payload:{theme:i}}),setView:i=>this._rdc.request({type:"SDK_SET_UI_VIEW",payload:{view:i}}),showSidebar:(i=!0)=>this._rdc.request({type:"SDK_TOGGLE_SIDEBAR",payload:{visible:i}})},this.preview={origin:"",getUrl:()=>this._rdc.request({type:"SDK_GET_PREVIEW_URL",payload:{}}).then(i=>i?.url??null),setUrl:(i="/")=>{if(typeof i!="string"||!i.startsWith("/"))throw new Error(`Invalid argument: expected a path starting with '/', got '${i}'`);return this._rdc.request({type:"SDK_SET_PREVIEW_URL",payload:{path:i}})}},this._rdc=new F(n),Object.defineProperty(this.preview,"origin",{value:typeof a.previewOrigin=="string"?a.previewOrigin:null,writable:!1})}applyFsDiff(n){let a=i=>i!==null&&typeof i=="object";if(!a(n)||!a(n.create))throw new Error("Invalid diff object: expected diff.create to be an object.");if(!Array.isArray(n.destroy))throw new Error("Invalid diff object: expected diff.destroy to be an array.");return this._rdc.request({type:"SDK_APPLY_FS_DIFF",payload:n})}getDependencies(){return this._rdc.request({type:"SDK_GET_DEPS_SNAPSHOT",payload:{}})}getFsSnapshot(){return this._rdc.request({type:"SDK_GET_FS_SNAPSHOT",payload:{}})}},x=[],j=class{constructor(n){this.id=ve(),this.element=n,this.pending=new Promise((a,i)=>{let t=({data:p,ports:g})=>{p?.action==="SDK_INIT_SUCCESS"&&p.id===this.id&&(this.vm=new L(g[0],p.payload),a(this.vm),u())},r=()=>{this.element.contentWindow?.postMessage({action:"SDK_INIT",id:this.id},"*")};function u(){window.clearInterval(M),window.removeEventListener("message",t)}window.addEventListener("message",t),r();let c=0,M=window.setInterval(()=>{if(this.vm){u();return}if(c>=20){u(),i("Timeout: Unable to establish a connection with the StackBlitz VM"),x.forEach((p,g)=>{p.id===this.id&&x.splice(g,1)});return}c++,r()},500)}),x.push(this)}},je=e=>{let n=e instanceof Element?"element":"id";return x.find(a=>a[n]===e)??null};function Re(e,n){let a=document.createElement("input");return a.type="hidden",a.name=e,a.value=n,a}function _e(e){return e.replace(/\[/g,"%5B").replace(/\]/g,"%5D")}function be({template:e,title:n,description:a,dependencies:i,files:t,settings:r}){if(!me.includes(e)){let p=me.map(g=>`'${g}'`).join(", ");console.warn(`Unsupported project.template: must be one of ${p}`)}let u=[],c=(p,g,K="")=>{u.push(Re(p,typeof g=="string"?g:K))};c("project[title]",n),typeof a=="string"&&a.length>0&&c("project[description]",a),c("project[template]",e,"javascript"),i&&(e==="node"?console.warn("Invalid project.dependencies: dependencies must be provided as a 'package.json' file when using the 'node' template."):c("project[dependencies]",JSON.stringify(i))),r&&c("project[settings]",JSON.stringify(r)),Object.entries(t).forEach(([p,g])=>{c(`project[files][${_e(p)}]`,g)});let M=document.createElement("form");return M.method="POST",M.setAttribute("style","display:none!important;"),M.append(...u),M}function Oe(e,n){let a=be(e);return a.action=_("/run",n),a.id="sb_run",`<!doctype html>
<html>
<head><title></title></head>
<body>
  ${a.outerHTML}
  <script>document.getElementById('${a.id}').submit();</script>
</body>
</html>`}function ze(e,n){let a=be(e);a.action=R("/run",n),a.target=N(n),document.body.appendChild(a),a.submit(),document.body.removeChild(a)}function D(e){return e?.contentWindow?(je(e)??new j(e)).pending:Promise.reject("Provided element is not an iframe.")}function Ne(e,n){ze(e,n)}function Je(e,n){let a=R(`/edit/${e}`,n),i=N(n);window.open(a,i)}function Ge(e,n){let a=R(`/github/${e}`,n),i=N(n);window.open(a,i)}function Ke(e,n,a){let i=z(e),t=Oe(n,a),r=document.createElement("iframe");return O(i,r,a),r.contentDocument?.write(t),D(r)}function We(e,n,a){let i=z(e),t=document.createElement("iframe");return t.src=_(`/edit/${n}`,a),O(i,t,a),D(t)}function He(e,n,a){let i=z(e),t=document.createElement("iframe");return t.src=_(`/github/${n}`,a),O(i,t,a),D(t)}var he={connect:D,embedGithubProject:He,embedProject:Ke,embedProjectId:We,openGithubProject:Ge,openProject:Ne,openProjectId:Je};var Se={CarService:`import { Injectable } from '@angular/core';
...
import { Subject } from 'rxjs';
    ...
    `};var Ve={"@angular/animations":"^19.0.1","@angular/cdk":"~19.0.1","@angular/cli":"^19.2.1","@angular/common":"^19.0.1","@angular/compiler":"^19.0.1","@angular/core":"^19.0.1","@angular/forms":"^19.0.1","@angular/platform-browser":"^19.0.1","@angular/platform-browser-dynamic":"^19.0.1","@angular/router":"^19.0.1","@primeng/themes":"^19.0.0","@types/jasmine":"4.3.1","@types/node":"12.20.55","chart.js":"^3.3.2",primeicons:"7.0.0",primeng:"^19.0.0",quill:"1.3.7",rxjs:"~7.8.1",tslib:"^2.5.0","tailwindcss-primeui":"^0.5.1","zone.js":"~0.15.0"},Ue={"@angular-devkit/build-angular":"^19.0.2","@angular/cli":"^19.0.1","@angular/compiler-cli":"^19.0.1","@angular/language-service":"~16.2.0","@types/jasmine":"~4.3.1","@types/node":"^16.18.67",codelyzer:"^0.0.28","jasmine-core":"~4.6.0",karma:"~6.4.2","karma-chrome-launcher":"~3.2.0","karma-coverage":"~2.2.0","karma-jasmine":"~5.1.0","karma-jasmine-html-reporter":"~2.0.0","ts-node":"~8.3.0",typescript:"~5.5.4",tailwindcss:"^3.4.17",autoprefixer:"^10.4.20",postcss:"^8.4.49"},Ye=e=>e.map(n=>`import { ${n} } from '@/service/${n.toLowerCase()}';`).join(""),Me=e=>e.split("-").map(n=>n.charAt(0).toUpperCase()+n.slice(1)).join(""),we=e=>{let n={};if(e&&e.length>0)for(let a=0;a<e.length;a++){let i=e[a];n[i.path]={content:i.content}}return n},$e=(e,n)=>{let a="";return e.forEach(i=>{a+=`import { ${i.name} } from 'src/app/demo/${i.name.toLowerCase()}';
`}),n?a+`import { ${Me(n)} } from 'src/app/demo/${n}';`:a},ke={global:`@tailwind base;
@tailwind components;
@tailwind utilities;
...
`,J=(e={})=>{let{code:n,extFiles:a,routeFiles:i,selector:t}=e,r=Me(t),u=we(a),c=we(i),M=$e(i,t),p=n.service?Ye(n.service):"",g=n.routerModule?n.routerModule:`RouterModule.forRoot([{ path: '', component: ${r} }])`,K=i&&i.length?r?i.map(f=>f.name).join(", ")+","+r:i.map(f=>f.name).join(", "):`${r}`,Ee=n.service&&n.service.length?n.service.map(f=>f).join(", "):"",Ae=`// Import PrimeNG modules
...
</html>`,Te={"src/main.ts":{content:`import { bootstrapApplication } from '@angular/platform-browser';
import { ${r} } from './app/${t}';
...
import Aura from '@primeng/themes/aura';
  ...
  export const appConfig: ApplicationConfig = {
    ...
    bootstrapApplication(${r}, appConfig).catch((err) =>
    console.error(err)
);`},"src/test.ts":{content:Ze},"tsconfig.json":{content:na},"tsconfig.app.json":{content:aa},"tsconfig.spec.json":{content:ia},".editorconfig":{content:Qe},"angular.json":{content:ea},"src/app/imports.ts":{content:Ae},"src/index.html":{content:Be},"src/karma.conf.js":{content:Xe},"src/styles.scss":{content:ke.global},"src/flags.css":{content:ke.flags},"src/app/themeswitcher.ts":{content:ra},"tailwind.config.js":{content:ta}},W=y(y(y({"package.json":{content:{name:`primeng-${t}`,description:`PrimeNG ${r}`,license:"MIT",keywords:[],scripts:{ng:"ng",start:"ng serve",build:"ng build",test:"ng test"},dependencies:y({},Ve),devDependencies:y({},Ue)}},[`src/app/${t}.ts`]:{content:n.typescript.trim()},[`src/app/${t}.html`]:{content:`<theme-switcher />
`+n.html.trim()}},Te),u),c);return n.service&&n.service.forEach(f=>{W[`src/service/${f.toLowerCase()}.ts`]={content:Se[f]}}),{files:W,title:`PrimeNG ${r}`}};var Ce=e=>{let{files:n}=J(e);n["sandbox.config.json"]={content:{infiniteLoopProtection:!1,template:"node",container:{node:"16"}}},fetch("https://codesandbox.io/api/v1/sandboxes/define?json=1",{method:"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:JSON.stringify({files:n,sourceFileName:"components/layout/app.component.ts"})}).then(a=>a.json()).then(a=>typeof window!==void 0&&window.open(`https://codesandbox.io/s/${a.sandbox_id}`,"_blank"))},Ie=e=>{let{files:n,title:a}=J(e),i={};Object.entries(n).forEach(([u,c])=>i[`${u}`]=typeof c.content=="object"?JSON.stringify(c.content,null,2):c.content);let t={title:a,template:"node",description:"PrimeNG is an open source UI library for Angular featuring a rich set of 80+ components, a theme designer, various theme alternatives such as Material, Bootstrap, Tailwind, premium templates and professional support. In addition, it integrates with PrimeBlock, which has 370+ ready to use UI blocks to build spectacular applications in no time.",files:i},r={newWindow:!0,openFile:"components/layout/app.component.html"};he.openProject(t,r)};var oa=["codeElement"],G=e=>({"code-active":e}),ca=e=>({"doc-section-code-active text-primary":e});function sa(e,n){if(e&1){let a=S();s(0,"button",18),w("click",function(){b(a);let t=d(3);return h(t.changeLang("html"))}),s(1,"span"),v(2,"HTML"),m()()}if(e&2){let a=d(3);l("ngClass",A(1,G,a.lang==="html"))}}function da(e,n){if(e&1){let a=S();s(0,"button",18),w("click",function(){b(a);let t=d(3);return h(t.changeLang("typescript"))}),s(1,"span"),v(2,"TS"),m()()}if(e&2){let a=d(3);l("ngClass",A(1,G,a.lang==="typescript"))}}function la(e,n){if(e&1){let a=S();s(0,"button",18),w("click",function(){b(a);let t=d(3);return h(t.changeLang("scss"))}),s(1,"span"),v(2,"SCSS"),m()()}if(e&2){let a=d(3);l("ngClass",A(1,G,a.lang==="scss"))}}function ma(e,n){if(e&1){let a=S();s(0,"button",19),w("click",function(){b(a);let t=d(3);return h(t.changeLang("data"))}),E(1,"i",20),m()}if(e&2){let a=d(3);l("ngClass",A(1,ca,a.lang==="data"))}}function ua(e,n){if(e&1&&(Q(0),I(1,sa,3,3,"button",16)(2,da,3,3,"button",16)(3,la,3,3,"button",16)(4,ma,2,3,"button",17),ee()),e&2){let a=d(2);o(),l("ngIf",a.code.html),o(),l("ngIf",a.code.typescript),o(),l("ngIf",a.code.scss),o(),l("ngIf",a.code.data)}}function pa(e,n){if(e&1){let a=S();s(0,"button",21),w("click",function(){b(a);let t=d(2);return h(t.toggleCode())}),E(1,"i",22),m()}}function ga(e,n){if(e&1){let a=S();s(0,"button",23),w("click",function(){b(a);let t=d(2);return h(t.openStackBlitz())}),U(),s(1,"svg",24),E(2,"path",25),m()()}}function ya(e,n){if(e&1&&(s(0,"pre",26)(1,"code",null,0),v(3),m()()),e&2){let a=d(2);o(3),k(`
`,a.code.basic,`

`)}}function va(e,n){if(e&1&&(s(0,"pre",27)(1,"code",null,0),v(3),m()()),e&2){let a=d(2);o(3),k(`
`,a.code.basic,`

`)}}function fa(e,n){if(e&1&&(s(0,"pre",27)(1,"code",null,0),v(3),m()()),e&2){let a=d(2);o(3),k(`
`,a.code.html,`

`)}}function ba(e,n){if(e&1&&(s(0,"pre",28)(1,"code",null,0),v(3),m()()),e&2){let a=d(2);o(3),k(`
`,a.code.typescript,`

`)}}function ha(e,n){if(e&1&&(s(0,"pre",29)(1,"code",null,0),v(3),m()()),e&2){let a=d(2);o(3),k(`
`,a.code.data,`

`)}}function Sa(e,n){if(e&1&&(s(0,"pre",30)(1,"code",null,0),v(3),m()()),e&2){let a=d(2);o(3),k(`
`,a.code.scss,`

`)}}function wa(e,n){if(e&1&&(s(0,"pre",31)(1,"code",null,0),v(3),m()()),e&2){let a=d(2);o(3),k(`
`,a.code.command,`

`)}}function ka(e,n){if(e&1){let a=S();s(0,"div",2)(1,"div",3),I(2,ua,5,4,"ng-container",4)(3,pa,2,0,"button",5)(4,ga,3,0,"button",6),s(5,"button",7),w("click",function(){b(a);let t=d();return h(t.copyCode())}),E(6,"i",8),m()(),s(7,"div",9),I(8,ya,4,1,"pre",10)(9,va,4,1,"pre",11)(10,fa,4,1,"pre",11)(11,ba,4,1,"pre",12)(12,ha,4,1,"pre",13)(13,Sa,4,1,"pre",14)(14,wa,4,1,"pre",15),m()()}if(e&2){let a=d();o(2),l("ngIf",a.fullCodeVisible),o(),l("ngIf",!a.hideToggleCode),o(),l("ngIf",!a.hideStackBlitz&&!a.hideToggleCode),o(4),l("ngIf",a.lang==="basic"&&a.importCode),o(),l("ngIf",a.lang==="basic"&&!a.importCode),o(),l("ngIf",a.lang==="html"),o(),l("ngIf",a.lang==="typescript"),o(),l("ngIf",a.lang==="data"),o(),l("ngIf",a.lang==="scss"),o(),l("ngIf",a.lang==="command")}}var Ma=(()=>{class e{platformId;document;code;service;selector;extFiles=[];routeFiles=[];hideToggleCode=!1;hideCodeSandbox=!0;hideStackBlitz=!1;importCode=!1;codeElement;fullCodeVisible=!1;lang;constructor(a,i){this.platformId=a,this.document=i}ngAfterViewChecked(){ce(this.platformId)&&window.Prism&&this.codeElement&&!this.codeElement.nativeElement.classList.contains("prism")&&(window.Prism.highlightElement(this.codeElement.nativeElement),this.codeElement.nativeElement.classList.add("prism"),this.codeElement.nativeElement.parentElement.setAttribute("tabindex","-1"))}ngOnInit(){this.lang=this.getInitialLang()}changeLang(a){this.lang=a}getInitialLang(){if(this.code)return Object.keys(this.code)[0]}copyCode(){return H(this,null,function*(){yield navigator.clipboard.writeText(this.code[this.lang])})}getCode(a="basic"){if(this.code)return this.fullCodeVisible||this.hideToggleCode?this.code[a]:this.code.basic}toggleCode(){this.fullCodeVisible=!this.fullCodeVisible,this.fullCodeVisible&&(this.code.html?this.lang="html":this.lang="typescript"),!this.fullCodeVisible&&(this.lang="basic")}openStackBlitz(){if(this.code){let a=this.code.typescript,i="import { ImportsModule } from './imports';";if(!a.includes(i)){let r=a.replace(/import\s+{[^{}]*}\s+from\s+'[^']+';[\r\n]*/g,c=>c.includes("Module")&&!c.includes("ReactiveFormsModule")?"":c);r=r.replace(/\bimports:\s*\[[^\]]*\]/,"imports: [ImportsModule]"),a=r.replace(/import\s+\{[^{}]*\}\s+from\s+'@angular\/core';/,c=>c+`
`+i)}let t=T(y({},this.code),{typescript:a});Ie({code:t,selector:this.selector,extFiles:this.extFiles,routeFiles:this.routeFiles})}}openCodeSandbox(){this.code&&Ce({code:this.code,selector:this.selector,extFiles:this.extFiles,routeFiles:this.routeFiles})}static \u0275fac=function(i){return new(i||e)(P($),P(Y))};static \u0275cmp=X({type:e,selectors:[["app-code"]],viewQuery:function(i,t){if(i&1&&ae(oa,5),i&2){let r;ne(r=ie())&&(t.codeElement=r.first)}},inputs:{code:"code",service:"service",selector:"selector",extFiles:"extFiles",routeFiles:"routeFiles",hideToggleCode:[2,"hideToggleCode","hideToggleCode",B],hideCodeSandbox:[2,"hideCodeSandbox","hideCodeSandbox",B],hideStackBlitz:[2,"hideStackBlitz","hideStackBlitz",B],importCode:[2,"importCode","importCode",B]},decls:1,vars:1,consts:[["codeElement",""],["class","doc-section-code",4,"ngIf"],[1,"doc-section-code"],[1,"doc-section-code-buttons","animate-scalein","animate-duration-300"],[4,"ngIf"],["pTooltip","Toggle Full Code","tooltipStyleClass","doc-section-code-tooltip","tooltipPosition","bottom","class","h-8 w-8 p-0 inline-flex items-center justify-center",3,"click",4,"ngIf"],["pTooltip","Edit in StackBlitz","tooltipPosition","bottom","tooltipStyleClass","doc-section-code-tooltip","class","h-8 w-8 p-0 inline-flex items-center justify-center",3,"click",4,"ngIf"],["type","button","pTooltip","Copy Code","tooltipPosition","bottom","tooltipStyleClass","doc-section-code-tooltip",1,"h-8","w-8","p-0","inline-flex","items-center","justify-center",3,"click"],[1,"pi","pi-copy"],["dir","ltr"],["class","language-javascript",4,"ngIf"],["class","language-markup",4,"ngIf"],["class","language-typescript",4,"ngIf"],["class","language-json",4,"ngIf"],["class","language-scss",4,"ngIf"],["class","language-shell",4,"ngIf"],["class","py-0 px-2 rounded-border h-8",3,"ngClass","click",4,"ngIf"],["pTooltip","View Data","tooltipPosition","bottom","tooltipStyleClass","doc-section-code-tooltip","class","h-8 w-8 p-0 inline-flex items-center justify-center",3,"ngClass","click",4,"ngIf"],[1,"py-0","px-2","rounded-border","h-8",3,"click","ngClass"],["pTooltip","View Data","tooltipPosition","bottom","tooltipStyleClass","doc-section-code-tooltip",1,"h-8","w-8","p-0","inline-flex","items-center","justify-center",3,"click","ngClass"],[1,"pi","pi-database"],["pTooltip","Toggle Full Code","tooltipStyleClass","doc-section-code-tooltip","tooltipPosition","bottom",1,"h-8","w-8","p-0","inline-flex","items-center","justify-center",3,"click"],[1,"pi","pi-code"],["pTooltip","Edit in StackBlitz","tooltipPosition","bottom","tooltipStyleClass","doc-section-code-tooltip",1,"h-8","w-8","p-0","inline-flex","items-center","justify-center",3,"click"],["role","img","width","13","height","18","viewBox","0 0 13 19","fill","currentColor","xmlns","http://www.w3.org/2000/svg",2,"display","'block'"],["d","M0 10.6533H5.43896L2.26866 18.1733L12.6667 7.463H7.1986L10.3399 0L0 10.6533Z"],[1,"language-javascript"],[1,"language-markup"],[1,"language-typescript"],[1,"language-json"],[1,"language-scss"],[1,"language-shell"]],template:function(i,t){i&1&&I(0,ka,15,10,"div",1),i&2&&l("ngIf",t.code)},dependencies:[oe,te,re,se,le,de],encapsulation:2})}return e})(),Va=(()=>{class e{static \u0275fac=function(i){return new(i||e)};static \u0275mod=Z({type:e});static \u0275inj=V({imports:[Ma]})}return e})();export{Ma as a,Va as b};

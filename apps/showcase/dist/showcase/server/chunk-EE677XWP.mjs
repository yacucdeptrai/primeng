...
import{a as S,b as H}from"./chunk-V2FTM5EX.mjs";import{a as U,b as k}from"./chunk-NT423BMI.mjs";import"./chunk-TILO7BIE.mjs";import{a as u,d as J,e as E}from"./chunk-HZSAMTDM.mjs";import{a as c,b as q}from"./chunk-EK6YV52O.mjs";import{b as N,e as y,f as B,g as W,i as j,j as C,k as R,l as L,m as G,s as O,t as P,u as z,v as K}from"./chunk-TFKM2WIB.mjs";import"./chunk-OEKEPL5T.mjs";import"./chunk-25YO5GOD.mjs";import"./chunk-3SL6YYR2.mjs";import"./chunk-DE54ZEHA.mjs";import"./chunk-YQJJ7I3T.mjs";import{j as A}from"./chunk-X4SEKHHA.mjs";import"./chunk-5H7TUZVV.mjs";import{v as I}from"./chunk-RUZVPFSZ.mjs";import{Bb as m,Cb as t,Db as i,Eb as s,O as F,Sa as a,cc as T,ec as e,gb as p,hb as _,jc as f,kc as g,lc as v,pc as V}from"./chunk-ZJKG6QAF.mjs";import"./chunk-AFOT676I.mjs";var Q=(()=>{class o{code={basic:`<span id="label_number">Number</span>
...
export class SliderInputDemo {
    value: number = 50;
}`};static \u0275fac=function(r){return new(r||o)};static \u0275cmp=p({type:o,selectors:[["input-doc"]],standalone:!1,decls:8,vars:3,consts:[[1,"card","flex","justify-center"],["type","text","pInputText","",1,"w-full","mb-4",3,"ngModelChange","ngModel"],[1,"w-full",3,"ngModelChange","ngModel"],["selector","slider-input-demo",3,"code"]],template:function(r,n){r&1&&(t(0,"app-docsectiontext")(1,"p"),e(2,"Slider is connected to an input field using two-way binding."),i()(),t(3,"div",0)(4,"div")(5,"input",1),v("ngModelChange",function(l){return g(n.value,l)||(n.value=l),l}),i(),t(6,"p-slider",2),v("ngModelChange",function(l){return g(n.value,l)||(n.value=l),l}),i()()(),s(7,"app-code",3)),r&2&&(a(5),f("ngModel",n.value),a(),f("ngModel",n.value),a(),m("code",n.code))},dependencies:[c,N,y,C,S,u,z],encapsulation:2})}return o})();var ee=(()=>{class o{rangeValues=[20,80];code={basic:'<p-slider [(ngModel)]="rangeValues" [range]="true" styleClass="w-56" />',html:`<div class="card flex justify-center">

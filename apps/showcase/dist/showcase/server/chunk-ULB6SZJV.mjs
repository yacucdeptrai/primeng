...
import{a as h}from"./chunk-LMW3OZ5S.mjs";import{a as B}from"./chunk-K66PAVXO.mjs";import"./chunk-GLPYBSVJ.mjs";import{a as U,b as oe}from"./chunk-PPCUCQZZ.mjs";import{a as Z}from"./chunk-XSLTCZBH.mjs";import"./chunk-ZAJPSZPD.mjs";import"./chunk-RNBAXVKN.mjs";import{a as x,d as ae,e as j}from"./chunk-HZSAMTDM.mjs";import{a as b,b as le}from"./chunk-EK6YV52O.mjs";import{s as X}from"./chunk-TFKM2WIB.mjs";import"./chunk-OEKEPL5T.mjs";import"./chunk-25YO5GOD.mjs";import"./chunk-3SL6YYR2.mjs";import{aa as I,ba as ie,f as ee,g as te}from"./chunk-DE54ZEHA.mjs";import{Ha as Y,qa as m}from"./chunk-YQJJ7I3T.mjs";import{f as J,j as Q}from"./chunk-X4SEKHHA.mjs";import"./chunk-5H7TUZVV.mjs";import{m as z,n as A,v as q}from"./chunk-RUZVPFSZ.mjs";import{$a as _,$b as G,Bb as p,Cb as o,Db as l,Dc as w,Eb as d,Lb as k,Ma as $,O as N,Qb as g,Sa as r,Sb as u,X as C,Y as y,ec as a,fc as M,gb as v,gc as H,hb as O,hc as K,mb as S,oc as F,pc as W}from"./chunk-ZJKG6QAF.mjs";import"./chunk-AFOT676I.mjs";var ne=(()=>{class t{static \u0275fac=function(i){return new(i||t)};static \u0275cmp=v({type:t,selectors:[["file-upload-accessibility-doc"]],standalone:!1,decls:18,vars:0,consts:[["routerLink","/button#accessibility"]],template:function(i,n){i&1&&(o(0,"app-docsectiontext")(1,"h3"),a(2,"Screen Reader"),l(),o(3,"p"),a(4,"FileUpload uses a hidden native "),o(5,"i"),a(6,"input"),l(),a(7," element with "),o(8,"i"),a(9,'type="file"'),l(),a(10," for screen readers."),l(),o(11,"h3"),a(12,"Keyboard Support"),l(),o(13,"p"),a(14,"Interactive elements of the uploader are buttons, visit the "),o(15,"a",0),a(16,"Button"),l(),a(17," accessibility section for more information."),l()())},dependencies:[x,J],encapsulation:2})}return t})();function ve(t,c){t&1&&(o(0,"div"),a(1,"Drag and drop files to here to upload."),l())}function ge(t,c){if(t&1&&(o(0,"li"),a(1),l()),t&2){let e=c.$implicit;r(),K("",e.name," - ",e.size," bytes")}}function xe(t,c){if(t&1&&(o(0,"ul"),S(1,ge,2,2,"li",6),l()),t&2){let e=u(2);r(),p("ngForOf",e.uploadedFiles)}}function he(t,c){if(t&1&&S(0,xe,2,1,"ul",5),t&2){let e=u();p("ngIf",e.uploadedFiles.length)}}var re=(()=>{class t{messageService;uploadedFiles=[];constructor(e){this.messageService=e}onUpload(e){for(let i of e.files)this.uploadedFiles.push(i);this.messageService.add({severity:"info",summary:"File Uploaded",detail:""})}code={basic:`<p-fileupload name="demo[]" url="https://www.primefaces.org/cdn/api/upload.php" (onUpload)="onUpload($event)" [multiple]="true" accept="image/*" maxFileSize="1000000" mode="advanced">
    <ng-template #empty>
